...
#ifdef AARCH64
  VPROFILE_TRACE_TSC=0x10,
  VPROFILE_TRACE_PC=0x20,
#endif
  VPROFILE_TRACE_STRICTLY_ORDERED=0x100,
  VPROFILE_TRACE_REG_IN_MEMREF=0x200,
  VPROFILE_TRACE_BEFORE_WRITE=0x400,
...
#ifdef AARCH64
  VPROFILE_TRACE_CCT_ADDR_TSC_PC = 
     VPROFILE_TRACE_CCT | VPROFILE_TRACE_ADDR | VPROFILE_TRACE_TSC | VPROFILE_TRACE_PC,
  VPROFILE_TRACE_ADDR_TSC_PC = 
    VPROFILE_TRACE_ADDR | VPROFILE_TRACE_TSC | VPROFILE_TRACE_PC,
#endif
