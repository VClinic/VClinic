...
{
    dr_set_client_name("DynamoRIO Client 'vprofile_mem_and_reg'",
    ...
    vtrace = vprofile_allocate_trace(VPROFILE_TRACE_DEFAULT | VPROFILE_TRACE_BEFORE_WRITE | ex_trace_flag);
