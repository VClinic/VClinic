...
// data prefetch
const size_t PREFETCH_CAPACITY = 50;

enum class CacheMissReason {
    COHERENCE,
    COHERENCE_TRUE_SHARING,
    COHERENCE_FALSE_SHARING,
    CAPACITY,
    CONFLICT
};
...
inline std::string reason_to_string(CacheMissReason reason) {
    switch (reason) {
        ...
        case CacheMissReason::COHERENCE_TRUE_SHARING: return "一致性缺失::真共享";
        case CacheMissReason::COHERENCE_FALSE_SHARING: return "一致性缺失::伪共享";
